...
bool thread_cmp_priority_v2 (const struct list_elem *a, const struct list_elem *b, void *aux UNUSED){
...
void
thread_donate_priority1 (struct thread *t)
{
  enum intr_level old_level = intr_disable ();
